  ...
  return (
    <div className="flex items-center flex-col pt-10 w-full h-full">
      <div className="flex w-full px-10">
        <div className="w-1/4 backdrop-blur bg-opacity-50 border border-blue-500 rounded-lg">
          <PlayerInMatch address="0x69ddB6f5Bd2d92C397Db173b98FF6dEEF204A3bB" coin_image="coin-front.svg" />
        </div>
        <div className="w-1/2 flex items-center flex-col">
          <CoinFlip getFlipState={getFlipState} />
        </div>
        <div className="w-1/4 backdrop-blur bg-opacity-50 border border-purple-500 rounded-lg">
          <PlayerInMatch address="0x69ddB6f5Bd2d92C397Db173b98FF6dEEF204A3bB" coin_image="coin-back.svg" />
        </div>
      </div>
