...
export const PreviousMatchPreview = ({ match, player }: MatchPreviewProps) => {
  return (
    ...
    >
      <MatchPreviewUser
        address={match.player1.wallet === player ? "You" : match.player1.wallet}
        stake={match.player1.nfts ? match.player1.nfts.length : 0}
      />
      <div className="text-lg">VS</div>
      <MatchPreviewUser
        address={match.player2.wallet === player ? "You" : match.player2.wallet}
        stake={match.player2.nfts ? match.player2.nfts.length : 0}
      />
